...
echo "<tr>\n";
echo "<th><font size='-1'>HiFi</font></th>\n";
echo "<th><font size='-1'>Spieler (Paßnummer, Team)</font></th>\n";
echo "</tr>\n";
...
while($data=mysql_fetch_array($antwort))
{
 ...
 $table ="<tr>\n";
 $table.="<td align='center'><font size='-1'>".$hifi."</font></td>\n";
 $table.="<td><font size='-1'>".$komplett."</font></td>\n";
 $table.="</tr>\n";
 echo $table;
...
echo "<table border='1' cellspacing='1' cellpadding='1' align='center'>\n";
echo "<tr>\n";
echo "<th><font size='-1'>Max's</font></th>\n";
echo "<th><font size='-1'>Spieler (Paßnummer, Team)</font></th>\n";
echo "</tr>\n";
...
while($data=mysql_fetch_array($antwort))
{
 ...
 $table ="<tr>\n";
 $table.="<td align='center'><font size='-1'>".$max."</font></td>\n";
 $table.="<td><font size='-1'>".$komplett."</font></td>\n";
 $table.="</tr>\n";
 echo $table;
