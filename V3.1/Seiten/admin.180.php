...
echo $tab;
echo "<br><a href='admin.180.php'>Zur&uuml;ck zur Eingabemaske...</a>\n";
...
<form action="admin.180.php" method="post" name="Max">
...
<p>Nein, lieber <a href="admin.180.php">zur&uuml;ck zur Eingabemaske...</a></p>
...
<form action="admin.180.php" method="post" name="Tag">
                <table align="center" cellspacing="3">
                  <tr>
...
?> 
<form action="admin.180.php" method="post" name="Saison">
