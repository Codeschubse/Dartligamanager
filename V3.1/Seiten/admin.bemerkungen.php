...
if($exist == 0)
{
  if (strlen($bemerkung)<1)// KEIN EINTRAG VORGENOMMEN
  {
    ...
    echo "<br><a href='admin.bemerkungen.php'>Zur&uuml;ck zur Eingabemaske...</a>\n";
  }
...
<form action="admin.bemerkungen.php" method="post" name="Bemerkung">
...
<form action="admin.bemerkungen.php" method="post" name="Tag">
                <table align="center" cellspacing="3">
...
?> 
<form action="admin.bemerkungen.php" method="post" name="Saison">
