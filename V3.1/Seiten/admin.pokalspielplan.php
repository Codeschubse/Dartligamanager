...
echo $tab;
echo "<br><br><a href='admin.pokalspielplan.php'>zur&uuml;ck zur Eingabemaske</a>\n";
...
echo "<br><br><a href='admin.pokalspielplan.php".$anhang."'>ausf&uuml;hren!</a>\n";
echo "<br><br><a href='admin.pokalspielplan.php'>zur&uuml;ck zur Eingabemaske</a>\n";
...
?>
                ...
                <form method="post" action="admin.pokalspielplan.php" name="Spieltag">
                  <table border="0">
                    <tr> 
...
echo "<option selected value='2005'>2005</option>\n";
...
//vorübergehend ein Jahr abziehen, weil Pokalspielplan erst nachträglich eingegeben wird
$jahrfolgendweniger=$jahrfolgend-1;
$jahrweniger=$jahr-1;

echo "<option value='$jahrfolgendweniger'>".$jahrfolgendweniger."</option>\n";
echo "<option selected value='$jahrweniger'>".$jahrweniger."</option>\n";
