...
$befehl.="and max_max is not null and max_pokal is null GROUP  BY max_pass ORDER  BY max DESC ";
$antwort=mysql_query($befehl);
...
$befehl.=" and max_hifi is not null and max_pokal is null order by max_hifi desc";
$antwort=mysql_query($befehl);
$anzahl=mysql_num_rows($antwort);
...
$befehl="select bem_text from bemerkungen where bem_saison='$saison' and bem_tag='$tag' and bem_pokal is null";
$antwort=mysql_query($befehl);
$data=mysql_fetch_array($antwort);
...
$befehl="select bem_text from bemerkungen where bem_saison='$saisonletzter' and bem_tag='$spieltag' and bem_pokal is null";
$antwort=mysql_query($befehl);
$data=mysql_fetch_array($antwort);
