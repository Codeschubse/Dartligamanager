...
$teamname ="<div align='center'><h2>".$data['team_name']."</h2><br>\n";
...
$teamname.="<br><a href='index.php?content=contact&amp;team=".$team."'>oder benutze das Kontaktformular...</a>";
}
$teamname.="<br><br>&nbsp;&nbsp;&nbsp;<a href='index.php?content=teams'>zur&uuml;ck zur &Uuml;bersicht</a></div>\n";
$teamname.="<div align='center'><h6><br>Gem&auml;&szlig; &sect; 28 BDSG widersprechen wir jeder kommerziellen Verwendung und Weitergabe unserer Daten!</h6></div><br>\n";
echo $teamname;
