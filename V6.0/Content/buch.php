...
if($GuestbookNew){
  ...
  if($error_msg){
     ...
     $message ="<br>Dein Eintrag konnte leider nicht in unser G&auml;stebuch aufgenommen werden:<br>";
     $message.=$error_msg;
     $message.="<br><br>Bitte klicke auf <a href='http://www.hdlev.de/index.php?content=guestbook.new'>zur&uuml;ck</a>.<br><br>";
...
$link_next="<a href='http://www.hdlev.de/index.php?content=guestbook&amp;pos=" . $new_pos_next . "'>weiter &gt;&gt;</a>";
}
$new_pos_prev=$pos-$count;
if($new_pos_prev<0){
$link_prev="&lt;&lt; zur&uuml;ck";
} else {
$link_prev="<a href='http://www.hdlev.de/index.php?content=guestbook&amp;pos=" . $new_pos_prev . "'>&lt;&lt; zur&uuml;ck</a>";
}
?> 
