...
//Captain und Lokal EintrÃ¤ge zusammensetzen
$cap = $datax['sp_vor']." ".$datax['sp_name'];
...
if($teammail){
$teamname.="<br><br><a href='index.php?content=contact&amp;team=".$team."'>Nachricht and dieses Team senden...</a>";
}
