  ...
  if(empty($errors))
   {
    ...
    // ...
		    ...
		    $action = 'passed';
				...
				echo "<p><strong>Fehler</strong>:Dein Gru&szlig; konnte nicht eingetragen werden. Bitte versuche es noch einmal. <a href=\"#\" onclick=\"history.back()\">Zurck zum Formular</a></p>";
			}
...
switch($action)
 {
  case 'main':
   ...
   <form action="<?php echo '?content=senf'; ?>" method="post">
   <div>
