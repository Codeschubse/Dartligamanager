  ...
  if(empty($errors))
   {
    ...
    // ...
		    ...
		    $action = 'passed';
				...
				echo "<p><strong>Fehler</strong>:Deine Nachricht konnte nicht gesendet werden. Bitte versuche es noch einmal. <a href=\"#\" onclick=\"history.back()\">Zurck zum Formular</a></p>";
			}
...
// Mist! In der folgenden Ausgabe steht immer "Webmaster", obwohl die Mail korrekt auch an andere $empfaenger verschickt wird.

   ?><p>Vielen Dank! Folgende Nachricht wurde <!--an <?php echo $empfaenger; ?> gesandt:-->abgeschickt:</p>
