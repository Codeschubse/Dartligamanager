...
$tab ="<table cellspacing='4'><tr>\n";
$tab.="<th colspan='3'>Folgende Daten wurden eingetragen:</th></tr>\n";
$tab.="<tr><td><b>Heim</b></td><td>&nbsp;</td>";
$tab.="<td><b>Gast</b></td></tr>\n";
...
?> 
<form method="post" action="index.php" name="Erg">
...
?> 
<form action="index.php" method="post" name="Saison">
                <table cellspacing="3">
                  <tr>
      <th colspan="2"><strong>Spielergebnisse&nbsp;eingeben</strong></th>
    <tr>
