...
switch($action)
 {
  case 'main':
   ...
   <p>Zum Schutz vor Mi&szlig;brauch des G&auml;stebuchs durch sogenannte <span class="color">&laquo;Spambots&raquo;</span> wird hier ein sogenanntes mathematisches <acronym title="Completely Automated Public Turing test to tell Computers and Humans Apart (w&ouml;rtlich &uuml;bersetzt bedeutet das Vollautomatischer &ouml;ffentlicher Turing-Test, um Computer und Menschen zu unterscheiden)">CAPTCHA</acronym> eingesetzt. Wenn Du lieber nicht kopfrechnen willst, verwende alternativ das Gru&szlig;formular mit einem <a href="?content=senf">grafischen CAPTCHA</a>.</p>
   ...
   <p style="margin-bottom:0px;">Bitte addiere die beiden Zahlen:<br /><?php
